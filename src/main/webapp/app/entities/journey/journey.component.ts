...
export default class Journey extends Vue {
  ...
  public retrieveAllJourneys(): void {
  ...
  public prepareRemove(instance: IJourney): void {
  ...
  public removeJourney(): void {
    this.journeyService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A Journey is deleted with identifier ' + this.removeId;
